...
import com.example.zfrproject.activity.AdminActivity;
...
//设置toolbar等
                    ...
                    if(username.length()!=0&password.length()!=0){
                        ...
                        for (User user : users) {
                            ...
                            if(user.username.trim().equals(username)&user.password.trim().equals(password)){
                                ...
                                Log.e("用户名",user.username.trim()+user.username.trim().length());
                                Log.e("密码",password+password.length());
                                Log.e("密码",user.password.trim()+user.password.trim().length());
                            }
                        }
                        if(!isTrue){
                            Toast.makeText(AdminLoginActivity.this, "用户名或密码不正确",
                        ...
                        Toast.makeText(AdminLoginActivity.this, "请输入用户名及密码",
                                Toast.LENGTH_SHORT).show();
                    }
            }
        }
    ...
    public String Select() {
        ...
        String sql = "SELECT [USERNAME] AS username,[PASSWORD] AS password FROM [Admin]";
